...
apt-get update
# apt-get install -y mercurial # I'm not using mercurial any  more
...
if [ ! -d "/usr/local/src/ccl" ]; then
  ...
  wget https://github.com/Clozure/ccl/releases/download/ccl-1.12.1-linuxx86.tar.gz
  tar xvf ccl-1.12.1-linuxx86.tar.gz
fi
